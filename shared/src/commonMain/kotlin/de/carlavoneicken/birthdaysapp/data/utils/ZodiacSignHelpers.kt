...
// Each range uses a "dummy" year 2000 because we only care about month/day
    val zodiacRanges = listOf(
        ...
        Triple(LocalDate(2000, 5, 21), LocalDate(2000, 6, 21), ZodiacSign.GEMINI),
        Triple(LocalDate(2000, 6, 22), LocalDate(2000, 7, 22), ZodiacSign.CANCER),
        ...
        Triple(LocalDate(2000, 9, 23), LocalDate(2000, 10, 23), ZodiacSign.LIBRA),
        Triple(LocalDate(2000, 10, 24), LocalDate(2000, 11, 21), ZodiacSign.SCORPIO),
